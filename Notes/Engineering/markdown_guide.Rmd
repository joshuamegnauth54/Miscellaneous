...
Markup languages provide small syntaxes that "markup" documents to indicate elements of presentation. Consider jotting down notes for class (or notes to pass to a friend in class)--you may underline or box terms for emphasis. In other words, you mark up your text!
...
Easy, right? Markdown (as well as LaTeX and [Jupyter](https://www.jupyter.org)) follows the principle of _not_ distracting the writer from their content with extravagent user interfaces and cumbrous clicking. Ultimately, Markdown leads to efficient and effacious technical document production despite having a learning curve in comparison to office suites.

Markdown files are saved as plain text
